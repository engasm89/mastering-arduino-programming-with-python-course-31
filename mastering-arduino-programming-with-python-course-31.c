 ...
 * 
 * Description:
 * This code demonstrates the core concepts taught in the "Mastering Arduino Programming With Python Course 31" course.
 ...
 * 
 * Course Link: https://www.udemy.com/course/mastering-arduino-programming-with-python-course-31/
 * Repository: https://github.com/engasm89/mastering-arduino-programming-with-python-course-31
 * 
